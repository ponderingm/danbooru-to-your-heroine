...
- 💎 **個人の語彙力を超える「タグ共起継承（Co-occurrence Inheritance）」**[^1]:
  ...
  - **希少性の美学（特異性スコア ＆ 背景ノイズ排除）**: 私たちが求めるのは**「ベン図における中心の重なり（コアモチーフ・装飾・フェチ行為）」**であり、空や海や大衆的な身体特徴といったバックグラウンドではありません。Danbooru全体でわずか数百件しか存在しないタグ（例: `labia_ring`）ほど、その1単語に凝縮された共起エネルギー（起爆力）が極めて高いため、GelbooruのAND積集合から得た母集団の局所共起率とDanbooru総登録件数（逆頻度IDF）を掛け合わせた「特異性スコア」によって、背景や身体ノイズを完全パージし、最も純度の高い中心核を逆算特定します。
