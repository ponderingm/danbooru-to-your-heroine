...
- 💎 **個人の語彙力を超える「タグ共起継承（Co-occurrence Inheritance）」**[^1]:
  ...
  - **希少性の美学（特異性・自己情報量の極大化）**: 共起の輪の中心核は、登録件数が少ないニッチなタグ（例: `labia_ring`）ほど美しく強靭です。Danbooru全体でわずか数百件しか存在しないタグほど、その1単語に凝縮された共起エネルギー（起爆力）が極めて高いため、GelbooruのAND積集合から得た母集団の局所共起率とDanbooru総登録件数（逆頻度IDF）を掛け合わせた「特異性スコア」によって、最も純度の高い中心核を逆算特定します。
